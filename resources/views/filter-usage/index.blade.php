<x-app-layout>
    <div class=" mx-auto w-[98%] lg:ml-12">
        <div class="flex justify-between items-center w-[90%] mx-auto my-8">
            <h1 class="text-2xl font-bold">FilterUSAGE</h1>
...
<th>ID</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <form action="{{ route('filter-usage.update', $filter->id) }}" method="POST"
                            class="update-form">
                            @csrf
                            @method('PUT')
                            <td>{{ $filter->id }}</td>
                        ...
                        <form action="{{ route('filter-usage.destroy', $filter->id) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
    ...
    <div id="default-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-2xl mx-auto p-4">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal Body -->
                <form action="{{ route('filter-usage.store') }}" method="POST" class="p-6 space-y-6">
                    @csrf
