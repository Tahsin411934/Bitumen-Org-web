...
<button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
 ...
 <aside id="sidebar-multi-level-sidebar" class="fixed shadow-2xl shadow-gray-300 lg:mt-16 top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
       ...
       <ul class="space-y-2 font-medium">
          ...
          <li>
             ...
             <ul id="dropdown-example" class="hidden py-2 space-y-2">
                   <li>
                      <a href="/products" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Products</a>
                   </li>
                   {{-- <li>
          ...
          <li>
            ...
            <ul id="dropdown-supplier" class="hidden py-2 space-y-2">
              {{-- <li>
                <a href="/suppliers/create" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add Suplier</a>
              </li> --}}
              <li>
                <a href="/suppliers" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Show Suplier</a>
              </li>
              {{-- <li>
    ...
    <script>
      const supplierButton = document.getElementById('supplier-dropdown-btn');
      const supplierDropdown = document.getElementById('dropdown-supplier');
      const supplierButtonIcon = supplierButton.querySelector('svg:last-child');
      
     
      supplierButton.addEventListener('click', () => {
        const isExpanded = supplierButton.getAttribute('aria-expanded') === 'true';
        
        
        supplierDropdown.classList.toggle('hidden');
        
       
        supplierButton.setAttribute('aria-expanded', !isExpanded);
        
        
        if (isExpanded) {
          supplierButtonIcon.style.transform = 'rotate(0deg)';
        } else {
          supplierButtonIcon.style.transform = 'rotate(180deg)';
        }
      });
    </script>
 </aside>
