        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="number" id="truck_id1" name="truck_id"
                    class="form-input rounded-md shadow-md p-3 w-full" placeholder="Truck ID" value="{{ $truck->truck_id }}" required />
            </div>
            <!-- Registration No -->
            <div>
                ...
                <input type="text" id="reg_no1" name="reg_no"
                    class="form-input rounded-md shadow-md p-3 w-full" placeholder="Registration No." value="{{ $truck->reg_no }}" required />
            </div>
            <!-- Capacity -->
            <div>
                <label for="capacity" class="block text-sm font-medium text-gray-700">Capacity</label>
                <input type="number" step="0.01" id="capacity1" name="capacity"
                    class="form-input rounded-md shadow-md p-3 w-full" placeholder="Capacity" value="{{ $truck->capacity }}" required />
            </div>
            <!-- Type -->
            <div>
            ...
            <div>
                ...
                <input type="text" id="brand1" name="brand"
                    class="form-input rounded-md shadow-md p-3 w-full" placeholder="Brand" value="{{ $truck->brand }}" required />
            </div>
            <!-- Year -->
            <div>
            ...
            <div>
                ...
                <input type="text" id="chassis_no1" name="chassis_no"
                    class="form-input rounded-md shadow-md p-3 w-full" placeholder="Chassis No." value="{{ $truck->chassis_no }}" required />
            </div>
            <!-- Tier Count -->
            <div>
                ...
                <input type="number" id="tier_count1" name="tier_count"
                    class="form-input rounded-md shadow-md p-3 w-full" placeholder="Tier Count" value="{{ $truck->tier_count }}" required />
            </div>
            <!-- Tier Size -->
            <div>
                ...
                <input type="text" id="tier_size1" name="tier_size"
                    class="form-input rounded-md shadow-md p-3 w-full" placeholder="Tier Size" value="{{ $truck->tier_size }}" required />
            </div>
            <!-- Mileage -->
            <div>
                ...
                <input type="number" step="0.01" id="mileage1" name="mileage"
                    class="form-input rounded-md shadow-md p-3 w-full" placeholder="Mileage" value="{{ $truck->mileage }}" required />
            </div>
            <!-- Fuel Type -->
            <div>
                ...
                <input type="text" id="fuel_type1" name="fuel_type"
                    class="form-input rounded-md shadow-md p-3 w-full" placeholder="Fuel Type" value="{{ $truck->fuel_type }}" required />
            </div>
            <!-- Status -->
            <div>
                <label for="status" class="block text-sm font-medium text-gray-700">Status</label>
                <select id="status" name="status1" class="form-select rounded-md shadow-md p-3 w-full"
                    required>
            ...
            <!-- Document Renewal Date -->
            <div>
                <label for="docRenewDate" class="block text-sm font-medium text-gray-700">Document Renewal Date</label>
                <input type="date" id="docRenewDate1" name="docRenewDate"
                    class="form-input rounded-md shadow-md p-3 w-full" placeholder="Document Renewal Date" value="{{ $truck->docRenewDate }}" required />
            </div>
        </div>
